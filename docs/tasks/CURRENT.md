...
| ----------------- | ----------- | -------------------------------------- | --------------------------------------- | ------- | -------- |
| `LANE-CORE`       | `TASK-007`  | OpenAPI foundation và generated client | `in_progress`                           | chưa có | chưa gán |
...
- **`TASK-007` · `LANE-CORE`**
  ...
  - Implementer PR: đang thực hiện trên branch `task/TASK-007-openapi-foundation-and-client-generator`
  - Reviewer: chưa gán
