...
| ----------------- | ----------- | --------------------------------------------------- | --------------------------------------- | ------- | -------- |
| `LANE-CORE`       | `TASK-006`  | GitHub Actions CI + secret/dependency scan baseline | `ready_for_review`                      | chưa có | chưa gán |
...
- **`TASK-006` · `LANE-CORE`**
  ...
  - Implementer PR: đang mở trên branch `task/TASK-006-ci-and-security-scan-baseline`
  - Reviewer: chưa gán
