...
| ----------------- | ----------- | ---------------------------------------- | --------------------------------------- | ------- | -------- |
| `LANE-CORE`       | `TASK-008b` | Permissions & role management migrations | `in_progress`                           | chưa có | chưa gán |
...
- **`TASK-008b` · `LANE-CORE`**
  ...
  - Implementer PR: đang thực hiện trên branch `task/TASK-008b-permissions-and-role-management-migrations`
  - Reviewer: chưa gán
